...
# shows the first 6 individuals on the list of samples
head(samples)
```

```{r snp_query, results = "hide"}
# query the variants (e.g., SNPs markers) in the selected run that match the given criteria:
